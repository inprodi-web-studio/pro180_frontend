...
export type CloudArrowUpsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function CloudArrowUpsvgIcon(props: CloudArrowUpsvgIconProps) {
...
export default CloudArrowUpsvgIcon;
/* prettier-ignore-end */
